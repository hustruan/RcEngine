...
void main()
{
    ...
    // box filter
    filtered += textureLodOffset(ShadowMap, iTex, 0, ivec2(-2, 0)).rg;
    filtered += textureLodOffset(ShadowMap, iTex, 0, ivec2(-1, 0)).rg;
    filtered += textureLodOffset(ShadowMap, iTex, 0, ivec2(0,  0)).rg;
    filtered += textureLodOffset(ShadowMap, iTex, 0, ivec2(1,  0)).rg;
    filtered += textureLodOffset(ShadowMap, iTex, 0, ivec2(2,  0)).rg;
	oFragColor = filtered;
